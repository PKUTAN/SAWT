...
class Encoder(nn.Module):
    ...
    def __init__(self,
        ...
        self.transformer_1 = MixEncoderLayer(hidden_dim,hidden_dim,8,hidden_dim//8,hidden_dim//8)
        self.transformer_2 = MixEncoderLayer(hidden_dim,hidden_dim,8,hidden_dim//8,hidden_dim//8)
        self.transformer_3 = MixEncoderLayer(hidden_dim,hidden_dim,8,hidden_dim//8,hidden_dim//8)
    ...
    def forward(self, input, flow_g,f_init_emb):
        ...
        flow_g_embedding = self.transformer_1(flow_g_embedding,flow_g)
        flow_g_embedding = self.transformer_2(flow_g_embedding,flow_g)
        flow_g_embedding = self.transformer_3(flow_g_embedding,flow_g)
